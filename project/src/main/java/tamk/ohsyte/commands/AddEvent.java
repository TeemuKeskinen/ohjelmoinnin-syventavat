...
public class AddEvent implements Runnable {
    @Option(names = {"-provider", "-p"}, required = false, description = "Event provider (sqlite, csv, text)")
    String provider;

    @Option(names = {"-date", "-d"}, required = true, description = "Date of the event (format: YYYY-MM-DD or --MM-DD)")
    String eventDate;

    @Option(names = {"-desc", "-de"}, required = false, description = "Description of the event")
    String eventDescription;

    @Option(names = {"-cat", "-c"}, required = false, description = "Category of the event")
    String category;
